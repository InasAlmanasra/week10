...
var querystring = "INSERT into formdata (name,surname,module,language, modulelist, geom) values ('";
querystring = querystring + req.body.name + "','" + req.body.surname + "','" + req.body.module + "','";
querystring = querystring + req.body.language + "','" + req.body.modulelist + "','"+geometrystring + "))";
